...
variable "subnet_name" {
  description = "The subnet name to create."
  type        = string
  default     = ""
}
...
variable "subnet_ids" {
  ...
  type        = list(string)
  default     = ["subnet-01df57500ea1af171", "subnet-065915f03cb41dc58"]
}
...
variable "aws_secretsmanager_rds_secret_arn" {
  description = "DB Master Credentials Secret Reference"
  type        = string
  default     = "arn:aws:secretsmanager:us-east-1:581142246841:secret:RDS/Aurora/Master_Credentials-SzAuxi"
}
...
# DB parameter group
variable "parameter_cluster_family" {
  description = "The Cluster Family of the DB cluster parameter group"
  type = string
  default = "aurora5.6"
}
...
variable "parameter_cluster_description" {
  description = "Description of the cluster parameter group to create"
  type = string
  default = ""
}
